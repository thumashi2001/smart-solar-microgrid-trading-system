...
function Layout({ children }) {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Segoe UI', Arial, sans-serif" }}>
      <div style={{ width: "260px", background: sidebarBg, display: "flex", flexDirection: "column", flexShrink: 0 }}>
        <div style={{ padding: "24px 20px", display: "flex", alignItems: "center", gap: "10px" }}>
          <span style={{ fontSize: "30px" }}>☀️</span>
          <div>
            <div style={{ color: "#fff", fontWeight: 700, fontSize: "17px", lineHeight: 1.2 }}>Smart Solar</div>
            <div style={{ color: "rgba(255,255,255,0.6)", fontSize: "11px" }}>Clean Energy Brighter Tomorrow</div>
          </div>
        </div>
...
>
  <span style={{ fontSize: "16px" }}>🚪</span> Logout
      ...
      <div style={{ flexGrow: 1, background: "#F7F5F1" }}>
        <div
          style={{
            background: "#fff",
        ...
        >
          <div style={{ textAlign: "right" }}>
            <div style={{ fontWeight: 600, fontSize: "14px", color: "#1C1F1E" }}>{fullName}</div>
            <div style={{ color: "#6B6862", fontSize: "12px" }}>{role}</div>
          </div>
         <div
  style={{
    width: "38px",
